...
@section('content')
    ...
    <div class="w-full mt-6">
        ...
        <h5 class='mb-10 text-2xl font-bold tracking-tight text-left text-gray-950 sm:text-center sm:text-3xl'>
            A {{ app(\App\Settings\GeneralSettings::class)->brand_name }} hírei
        </h5>

        <div class="grid grid-cols-2 gap-4 xl:grid-cols-4 md:grid-cols-3">
            @foreach ($dosz_hirek as $hir)
                <div class="card">
                    <figure>
