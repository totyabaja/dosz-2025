@php
    $currentFolder = \TotyaDev\TotyaDevMediaManager\Models\Folder::find($this->folder_id);
    if (filament('totyadev-media-manager')->allowSubFolders) {
                            ...
                            <div
                                ...
                                <div class="flex flex-col items-center justify-center h-full p-4">
                                    ...
                                    @else
                                        @php
                                            $hasPreview = false;
                                            $loadTypes = \TotyaDev\TotyaDevMediaManager\Facade\FTotyaDevMediaManager::getTypes();
                                            $type = null;
                            ...
                            <div class="flex flex-col justify-start w-full h-full">
                                ...
                                <div class="flex flex-col gap-4 my-4">
                                    ...
                                    <div>
                                        <div>
                                            <h1 class="font-bold">
                                                {{ trans('totyadev-media-manager::messages.media.meta.type') }}</h1>
                                        </div>
                                        <div class="flex justify-start">
                                            <p class="text-sm">
                                                {{ $item->mime_type }}
                                    ...
                                    <div>
                                        <div>
                                            <h1 class="font-bold">
                                                {{ trans('totyadev-media-manager::messages.media.meta.size') }}</h1>
                                        </div>
                                        <div class="flex justify-start">
                                            <p class="text-sm">
                                    ...
                                    <div>
                                        <div>
                                            <h1 class="font-bold">
                                                {{ trans('totyadev-media-manager::messages.media.meta.disk') }}</h1>
                                        </div>
                                        <div class="flex justify-start">
                                            <p class="text-sm">
                                                {{ $item->disk }}
