...
use TotyaDev\TotyaDevMediaManager\Resources\FolderResource\Pages;
use TotyaDev\TotyaDevMediaManager\Resources\FolderResource\RelationManagers;
...
class FolderResource extends Resource
{
    ...
    {
        return Folder::class; // TODO: Change the autogenerated stub
    }

    public static function getNavigationLabel(): string
    {
        return trans('totyadev-media-manager::messages.folders.title');
    }
    ...
    {
        return trans('totyadev-media-manager::messages.folders.single'); // TODO: Change the autogenerated stub
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Hidden::make('user_id')->visible(filament('totyadev-media-manager')->allowUserAccess)->default(auth()->id()),
                Forms\Components\Hidden::make('user_type')->visible(filament('totyadev-media-manager')->allowUserAccess)->default(get_class(auth()->user())),
        ...
        return $table
            ->modifyQueryUsing(function (Builder $query) {
                if (request()->has('model_type') && !request()->has('collection')) {
                    ...
                    $query
                        ->where('model_type', request()->get('model_type'))
            ...
            ->content(function () {
                return view('totyadev-media-manager::pages.folders');
            })
            ->columns([
