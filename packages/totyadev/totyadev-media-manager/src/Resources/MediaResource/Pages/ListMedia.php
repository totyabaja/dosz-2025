...
use TotyaDev\TotyaDevMediaManager\Resources\Actions\CreateMediaAction;
use TotyaDev\TotyaDevMediaManager\Resources\Actions\CreateSubFolderAction;
use TotyaDev\TotyaDevMediaManager\Resources\Actions\DeleteFolderAction;
use TotyaDev\TotyaDevMediaManager\Resources\Actions\EditCurrentFolderAction;
...
class ListMedia extends ManageRecords
{
    ...
    protected function getHeaderActions(): array
    {
        ...
        if (filament('totyadev-media-manager')->allowUserAccess && (!empty($folder->user_id))) {
