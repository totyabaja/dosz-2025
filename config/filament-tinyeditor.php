...
return [
    ...
    'profiles' => [
        'default' => [
            'plugins' => 'autoresize directionality advlist link image lists preview pagebreak searchreplace fullscreen insertdatetime media table',
            'toolbar' => 'undo redo removeformat | styles | bold italic underline | alignleft aligncenter alignright | numlist bullist outdent indent | forecolor | table toc | image link media | fullscreen preview',
